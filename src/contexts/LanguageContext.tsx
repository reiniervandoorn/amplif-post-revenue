...
const translations = {
  ...
  nl: {
    ...
    'merchants.hero.subtitle': 'Maak van je bedankpagina een omzet-krachtpatser. Verhoog je gemiddelde bestelwaarde met 15-40% zonder operationele overhead en met volledige controle over je merk.',
    'merchants.hero.startTrial': 'Start Je Gratis Proefperiode',
    'merchants.valueProps.title': 'Waarom Merchants van AmplifAI houden',
    'merchants.valueProps.subtitle': 'Alles wat je nodig hebt om extra omzet te genereren zonder extra werk',
    'merchants.valueProps.foundMargin.title': 'Gevonden Marge, Nul Extra Operaties',
    ...
    'merchants.valueProps.brandSafe.desc': 'Volledige controle over partneraanbiedingen met toe/afwijzingslijsten, categorierestricties en merkrichtlijnen. Behoud je reputatie.',
    'merchants.valueProps.fastGoLive.title': '1-Dag Live, 7-Dag ROI',
    ...
    'merchants.valueProps.aiPowered.title': 'AI-gestuurde Optimalisatie',
    'merchants.valueProps.aiPowered.desc': 'Onze machine learning verbetert voortdurend de relevantie en timing van aanbiedingen om conversieratio\'s te maximaliseren.',
    'merchants.valueProps.analytics.title': 'Uitgebreide Analytics',
    'merchants.valueProps.analytics.desc': 'Real-time dashboard met prestatiemetrieken, omzettoewijzing en optimalisatiekansen.',
    ...
    'merchants.results.aovIncrease': 'Gem. AOV Stijging',
    ...
    'merchants.results.revenueDesc': 'Extra inkomsten',
    'merchants.results.daysToROI': 'Dagen tot ROI',
    'merchants.results.roiDesc': 'Break-even tijdlijn',
    'merchants.integration.title': 'Aan de Slag is Eenvoudig',
    'merchants.integration.subtitle': 'Van installatie tot eerste verkoop in minder dan 30 minuten',
    'merchants.integration.step1.title': 'Verbind Je Webshop',
    ...
    'merchants.integration.step3.desc': 'Begin met het tonen van relevante aanbiedingen aan je klanten',
    'merchants.integration.step3.timeline': 'Direct',
    'merchants.integration.step4.title': 'Zie Resultaten',
    'merchants.integration.step4.desc': 'Monitor prestaties en optimaliseer je strategie',
    'merchants.integration.step4.timeline': '7 dagen',
    'merchants.platforms.title': 'Werkt Met Jouw Platform',
    ...
    'merchants.faq.platforms.a': 'AmplifAI werkt met alle grote platforms inclusief Shopify, WooCommerce, Magento, BigCommerce, Salesforce Commerce Cloud en custom builds. We bieden native integraties en universele JavaScript snippets.',
    'merchants.faq.refunds.q': 'Hoe werken terugbetalingen?',
    'merchants.faq.refunds.a': 'Ons terugbetaalkoppelingssysteem handelt automatisch add-on terugbetalingen af wanneer het originele item wordt geretourneerd. Als klanten het hoofdproduct retourneren, worden gerelateerde add-ons proportioneel terugbetaald, waarbij complete transactie-integriteit behouden blijft.',
    'merchants.faq.control.q': 'Welke controle heb ik over partneraanbiedingen?',
    'merchants.faq.control.a': 'Volledige controle. Je kunt categorierestricties instellen, toe/afwijzingslijsten bijhouden voor specifieke partners, goedkeuring vereisen voor nieuwe aanbiedingen, en ervoor zorgen dat alle partnercommunicatie je merkrichtlijnen volgt.',
    'merchants.faq.vetting.q': 'Hoe worden partners gescreend?',
    'merchants.faq.vetting.a': 'Alle partners doorlopen ons uitgebreide KYC-proces inclusief bedrijfslicentie verificatie, verzekeringscontroles, klantreview analyse en financiële status beoordeling. Alleen hoogkwalitatieve, betrouwbare partners worden goedgekeurd.',
    'merchants.faq.revenue.q': 'Wat is de omzetverdeling?',
    'merchants.faq.revenue.a': 'Je verdient commissie op alle partnerverkopen gegenereerd via je klanten, typisch 10-25% afhankelijk van de servicecategorie. Er zijn geen upfront kosten of maandelijkse kosten - je betaalt alleen wanneer je verdient.',
    'merchants.faq.design.q': 'Kan ik het widget-ontwerp aanpassen?',
    'merchants.faq.design.a': 'Ja, de widget is volledig aanpasbaar om te matchen met je merkkleuren, lettertypen en styling. We bieden ook A/B-testtools om het ontwerp te optimaliseren voor maximale conversie.',
    'merchants.cta.title': 'Klaar om je omzet te verhogen?',
    'merchants.cta.subtitle': 'Sluit je aan bij honderden merchants die al extra omzet genereren met AmplifAI. Geen installatiekosten, geen risico, puur voordeel.',
    'merchants.cta.button': 'Neem Contact Op',

    // Partners Page
    'partners.hero.title': 'Voor <span class="gradient-text">Partners</span>',
    'partners.hero.subtitle': 'Bereik nieuwe klanten op het perfecte moment - direct nadat ze een aankoop hebben gedaan. Sluit je aan bij ons netwerk en laat je bedrijf groeien met high-intent, gekwalificeerde leads.',
    'partners.hero.joinNetwork': 'Sluit Je Aan Bij Ons Netwerk',
  }
};
